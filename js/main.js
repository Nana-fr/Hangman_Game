...
function askPlayerLetter() {
    let letter = prompt(`Choose a letter.\n\nBe careful to not choose one you have already checked, otherwise you will waste a chance:\n${usedLetters}`);
...
switch (val) {
    case "R": // to the storyline explaining the rules of the game
    case "r":
        alert(`Somewhere, in the middle of the night,
        ...
        \n\t...Ok ok, stop crying, you're going to make me deaf!
        \n\tYou're so lucky to have met me, the GREAT and INCREDIBLE spirit of this land. Since I'm nice and in a good mood, I'm going to help you:
        \n\tIf you go back to the main room you will see a door with a *S* on it. Open this door and give the *correct password* to the guard. He will let you out without looking at you and you will be safe. If not... you will get a pretty rope around your neck. Ha ha ha!
        ...
        \n\t...What? You want me to give you the password? Keep dreaming! Stealing is bad, be grateful the GREAT ME is helping you!
        \n\tOh and remember don't be stupid, there are *only letters* in the password, if you choose a special character like '/', you will *waste a chance*. The same goes if you choose a previously chosen letter even if it was one in the password.
        \n\tNow off you go, and good luck! ^‿^`);
        break;
